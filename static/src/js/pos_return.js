odoo.define('pos_return.return_screens', function (require) {
    "use strict";
    ...
    var account_journal_index = _.findIndex(existing_models, function (model) {
        return model.model === "account.journal";
    });
    var order_model_index = _.findIndex(existing_models, function (model) {
        return model.model === "pos.order";
    });

    var account_journal = model_list[account_journal_index];
    var order_model = model_list[order_model_index];
    models.load_fields("account.journal", "allow_return");
    ...
    screens.ProductScreenWidget.include({
        return_confirm: function(ref,open_order){
            ...
            rpc.query({
                ...
                method: 'search_read',
                domain: domain,
                fields: ['id', 'pos_reference', 'partner_id', 'lines'],
                ...
                if (result && result.length == 1) {
                    ...
                    rpc.query({
                        model: 'pos.order',
                        method: 'get_return_order',
                        args: [[result[0].id]],
                    }).then(function(ROrder){
